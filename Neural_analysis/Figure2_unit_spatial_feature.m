function Figure2_unit_spatial_feature
...
unitid=[71,13,55,15];v1=1;vid=4;position0=110;Bin_Size=2;ns=[];unitcode=[1,2,5,6];
figure;
for u=2%:4
    indu=unitall(:,16)==unitcode(u);
    unit=unitall(indu,:);
...
figure_title='SupFigure14_unit_spatial_move_immobile_theta';save_current_figure(figure_title);
